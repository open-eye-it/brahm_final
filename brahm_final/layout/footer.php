...
<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
	...
	<div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
		...
		<div class="text-dark order-2 order-md-1">
			<span class="text-muted font-weight-bold mr-2">20224©</span>
			<a href="" target="_blank" class="text-dark-75 text-hover-primary">East London & Essex Brahm Samaj</a>
		</div>
		<!--end::Copyright-->
		<!--begin::Nav-->
	...
	<div class="offcanvas-content pr-5 mr-n5">
		...
		<div class="d-flex align-items-center mt-5">
			...
			<div class="d-flex flex-column">
				...
				<div class="navi mt-2">
					<a href="<?php echo $base_url; ?>signout.php" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Sign Out</a>
				</div>
			</div>
		</div>
		<!--end::Header-->
...
<!--end::Page Vendors-->
<!--begin::Page Scripts(used by this page)-->
<script src="<?php echo $base_url; ?>assets/js/pages/crud/datatables/basic/basic.js"></script>
<!--end::Page Scripts-->
<script type="text/javascript">
	function timeOut(id, time = 3000) {
		setTimeout(() => {
			$('#' + id).html('');
		}, time);
	}
