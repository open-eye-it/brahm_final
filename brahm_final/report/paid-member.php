								...
								<div class="card card-custom gutter-b">
									<div class="card-header flex-wrap py-3">
										...
										<div class="card-toolbar">
                                            <a href="<?php echo $base_url.'report/export-current-paid-member.php'; ?>" class="btn btn-primary"><i class="fa fa-file-export text-white"></i> Export</a>
                                        </div>
									</div>
									<div class="rot">
...
function searchMember(){
	let year = $('#year').val();
	window.location.href="<?php echo $base_url; ?>report/paid-member-view.php?year="+year;
}
</script>