								...
								<div class="card card-custom gutter-b example example-compact">
                                            <div class="card-header flex-wrap py-3">
                                                <div class="card-title">
                                                    <h3 class="card-label">Member Full Detail</h3>
                                                </div>
                                                <div class="card-toolbar">
                                                    <a href="<?php echo $base_url.'membership/member-list.php?family='.$family_arr[1]; ?>" class="btn btn-primary"><i class="fa fa-arrow-left text-white"></i> Back</a> &nbsp;
                                                </div>
                                            </div>
											<!--begin::Form-->
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <span class="text-danger">*</span></label>
                                                            <input type="text" class="form-control" placeholder="Surname" name="SurName" id="SurName" value="<?php echo $memberData['SurName']; ?>"  disabled />
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <span class="text-danger">*</span></label>
                                                            <input type="text" class="form-control" placeholder="Name" name="FirstName" id="FirstName" value="<?php echo $memberData['FirstName']; ?>"  disabled />
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <span class="text-danger">*</span></label>
                                                            <input type="text" class="form-control" placeholder="Father's Name" name="MiddleName" id="MiddleName" value="<?php echo $memberData['MiddleName']; ?>"  disabled />
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <span class="text-danger">*</span></label>
                                                            <select name="Relation" id="Relation" class="form-control"  disabled>
                                                                <option value="">-Select-</option>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <span class="text-danger">*</span></label>
                                                            <input type="date" class="form-control" placeholder="CountryBirth Date" name="DOB" id="DOB" value="<?php echo $memberData['DOB']; ?>"  disabled />
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <span class="text-danger">*</span></label>
                                                            <select name="M_Status" id="M_Status" class="form-control"  disabled>
                                                                <option value="">-Select-</option>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Mosal" name="Mosal" id="Mosal" value="<?php echo $memberData['Mosal']; ?>"  disabled />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            <label for="usrName">Qualification</label>
                                                            <input type="text" class="form-control" placeholder="Qualification" name="Qualification" id="Qualification" value="<?php echo $memberData['Qualification']; ?>"  disabled />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            <label for="usrName">Occupation</label>
                                                            <input type="text" class="form-control" placeholder="Occupation" name="Occupation" id="Occupation" value="<?php echo $memberData['Occupation']; ?>"  disabled />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            <label for="usrName">Email</label>
                                                            <input type="email" class="form-control" placeholder="Email" name="Email" id="Email" value="<?php echo $memberData['Email']; ?>"  disabled />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <span class="text-danger">*</span></label>
                                                            <select name="Created_Year" id="Created_Year" class="form-control" disabled>
                                                                <option value="">-Select-</option>
