...
if(count($uri_arr) > 1){
    if($uri_arr[0] == 'member'){
        $familyIid = $uri_arr[1];
        $res = $membershipModel->singleFamily($familyIid);
...
if(isset($_POST['member_update'])){
	...
	$createRes = $membershipModel->updateFamily($InsertArr, $familyIid);
							...
							<div class="content flex-column-fluid" id="kt_content">
								...
								<div class="card card-custom gutter-b example example-compact">
											<div class="card-header">
												<h3 class="card-title">Update Family</h3>
											</div>
											<!--begin::Form-->
											<form method="post" action="" id="newUserUpdate">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                                <label for="usrName">Family's Native Place
                                                                <span class="text-danger">*</span></label>
                                                                <input type="text" class="form-control" placeholder="Family's Native Place" name="native" id="native" value="<?php echo $data['native']; ?>" />
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <span class="text-danger">*</span></label>
                                                                <input type="text" class="form-control" placeholder="House Number" name="add1" id="add1" value="<?php echo $data['add1']; ?>" />
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <span class="text-danger">*</span></label>
                                                                <input type="text" class="form-control" placeholder="Bungalow / Appt. Name" name="add2" id="add2" value="<?php echo $data['add2']; ?>" />
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <span class="text-danger">*</span></label>
                                                                <input type="text" class="form-control" placeholder="Street Name" name="add3" id="add3" value="<?php echo $data['add3']; ?>" />
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <span class="text-danger">*</span></label>
                                                                <input type="text" class="form-control" placeholder="Area" name="add4" id="add4" value="<?php echo $data['add4']; ?>" />
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <span class="text-danger">*</span></label>
                                                                <input type="text" class="form-control" placeholder="Country" name="county" id="county" value="<?php echo $data['county']; ?>" />
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <span class="text-danger">*</span></label>
                                                                <input type="text" class="form-control" placeholder="Zipcode" name="zipcode" id="zipcode" value="<?php echo $data['zipcode']; ?>" />
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control" placeholder="Phone1" name="phone1" id="phone1" value="<?php echo $data['phone1']; ?>" />
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control" placeholder="Phone2" name="phone2" id="phone2" value="<?php echo $data['phone2']; ?>" />
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <span class="text-danger">*</span></label>
                                                                <input type="number" class="form-control" placeholder="Mobile1" name="mobile1" id="mobile1" value="<?php echo $data['mobile1']; ?>" />
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control" placeholder="Mobile2" name="mobile2" id="mobile2" value="<?php echo $data['mobile2']; ?>" />
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                                <label for="usrName">Remarks</label>
                                                                <textarea class="form-control" name="remarks" id="remarks" cols="30" rows="10" placeholder="Remarks"><?php echo $data['remarks']; ?></textarea>
												...
												<div class="card-footer">
                                                    <input type="hidden" name="member_update" id="member_update" value="member_update">
